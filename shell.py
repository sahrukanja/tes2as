...
cl = TOBY.LINE()
cl.login(token="EnjQVNVBA1vR4MNFhp7c.4FFDJecIXzpQTVkI1dCsRa.UCZVvTq6h/o0J+7sPOKjA/YgylQnDSRuz+xdF1NI9kw=")
cl.loginResult()

ki = TOBY.LINE()
ki.login(token="En64xMHRZx6OCpDhByE8.FieZq04bFjJ1xrDjPMJBoa.WF7UzZzfme+0meKWP/01mJz5Aw1IfvCu6EAXmAUYh38=")
ki.loginResult()

ki2 = TOBY.LINE()
ki2.login(token="EnzWoYdmEaJ9u712ZiQd.oCfYsJKis8Urlb6MFJutNq.2ch3+zTvszUwPACmIydpJtjK1M77p7/4uO9xxCM5d+Q=")
ki2.loginResult()
...
admin = ["ue1f7dd8c40a2c593eab6f2a2d43712ac"]
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "uda936836a9869eb86ec8ab992a4e8979":
                    if "join:" in msg.text:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                return
            elif msg.text in ["Help","help","Key","key"]:
                if wait["lang"] == "JP":
                ...
                cl.sendMessage(msg) 
                msg.contentType = 13
            elif "vipro1" == msg.text:
                msg.contentType = 13
                msg.contentMetadata = {'mid': kimid}
                ki.sendMessage(msg)
            elif "vipro2" == msg.text:
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki2mid}
                ki2.sendMessage(msg)
...
#-------------------------------------------------------------------
            elif msg.text in ["absen bot","Absen bot"]:
              if msg.from_ in admin:
                cl.sendText(msg.to,"⭐⭐⭐")
                ki.sendText(msg.to,"⭐⭐⭐⭐")
                ki2.sendText(msg.to,"⭐⭐⭐⭐⭐")
...
#-----------------------------------------------
            if op.type == 17:
              ...
              cl.sendText(op.param1,"Budayakan Baca Note !!! yah Ka 😊\nSemoga Betah Kk 😘")
              print "MEMBER HAS JOIN THE GROUP"
            if op.type == 15:
              if op.param2 in Bots:
                 return
              cl.sendText(op.param1, "Bye bye 😬😬 ")
...
#-----------------------------------------------
                        ...
                        ki2.updateGroup(G)
#-----------------------------------------------
            elif msg.text in ["vipro","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in admin:
                G = cl.getGroup(msg.to)
                ginfo = cl.getGroup(msg.to)
                G.preventJoinByTicket = False
...
#-----------------------------------------------
            ...
            elif msg.text in ["like tl", "Bot like temen"]: #Semua Bot Ngelike Status Teman
              if msg.from_ in admin:
                print "[Command]Like executed"
     ...
     for zx in range(0,50):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ♣️Vipro♣️\n\nhttp://line.me/ti/p/~gjxvipro")
            ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ♣️Vipro♣️\n\nhttp://line.me/ti/p/~gjxvipro")
            ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ♣️Vipro♣️\n\nhttp://line.me/ti/p/~gjxvipro")
            print "Like"
            print "Like"
            print "Like"
          except:
